...
public class RecyclabilityRatingMissingEntirelyGroupedValidatorTests
{
    ...
    [TestMethod]
    public async Task ValidateAsync_AddsWarning_During2025H1_When_AllEligibleLargeProducerRowsHaveMissingRecyclabilityRating()
    {
        var errors = new List<ProducerValidationEventIssueRequest>();
        var warnings = new List<ProducerValidationEventIssueRequest>();
        var rows = new List<ProducerRow>
        {
            BuildProducerRow(packagingType: PackagingType.Household, materialType: MaterialType.Plastic, recyclabilityRating: string.Empty, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025"),
            BuildProducerRow(packagingType: PackagingType.PublicBin, materialType: MaterialType.PaperCard, recyclabilityRating: null, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025"),
            BuildProducerRow(packagingType: PackagingType.HouseholdDrinksContainers, materialType: MaterialType.Glass, recyclabilityRating: " ", dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025")
        };
    ...
    [TestMethod]
    public async Task ValidateAsync_DoesNotAddWarning_During2025H1_When_AnyEligibleLargeProducerRowHasRecyclabilityRating()
    {
        var errors = new List<ProducerValidationEventIssueRequest>();
        var warnings = new List<ProducerValidationEventIssueRequest>();
        var rows = new List<ProducerRow>
        {
            BuildProducerRow(packagingType: PackagingType.Household, materialType: MaterialType.Plastic, recyclabilityRating: string.Empty, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025"),
            BuildProducerRow(packagingType: PackagingType.PublicBin, materialType: MaterialType.PaperCard, recyclabilityRating: RecyclabilityRating.Green, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025")
        };
    ...
    [TestMethod]
    public async Task ValidateAsync_DoesNotAddWarning_During2025H1_When_NoEligibleRowsExist()
    {
        var errors = new List<ProducerValidationEventIssueRequest>();
        var warnings = new List<ProducerValidationEventIssueRequest>();
        var rows = new List<ProducerRow>
        {
            BuildProducerRow(packagingType: PackagingType.NonHousehold, materialType: MaterialType.Plastic, recyclabilityRating: string.Empty, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025"),
            BuildProducerRow(packagingType: PackagingType.HouseholdDrinksContainers, materialType: MaterialType.Plastic, recyclabilityRating: string.Empty, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025"),
            BuildProducerRow(producerSize: ProducerSize.Small, packagingType: PackagingType.Household, materialType: MaterialType.Plastic, recyclabilityRating: string.Empty, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025")
        };
    ...
    [DataRow(ErrorCode.LargeProducerRecyclabilityRatingNotRequired)]
    [DataRow(ErrorCode.LargeProducerRecyclabilityPartiallySupplied)]
    public async Task ValidateAsync_SkipsValidation_During2025H1_When_BreakingErrorAlreadyRaised(string errorCode)
    {
        var warnings = new List<ProducerValidationEventIssueRequest>();
        var row = BuildProducerRow(packagingType: PackagingType.Household, materialType: MaterialType.Plastic, recyclabilityRating: string.Empty, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025");
        var rows = new List<ProducerRow> { row };
        var errors = new List<ProducerValidationEventIssueRequest>
        {
            BuildIssueRequest(row, errorCode)
    ...
    [TestMethod]
    public async Task ValidateAsync_SkipsValidation_During2025H1_When_NoRemainingIssueCapacity()
    {
        _issueCountServiceMock.Setup(x => x.GetRemainingIssueCapacityAsync(It.IsAny<string>())).ReturnsAsync(0);
    ...
    [TestMethod]
    public async Task ValidateAsync_AddsWarning_During2025H1_When_MixedEligibleRowsAllHaveMissingRecyclabilityRating()
    {
        var errors = new List<ProducerValidationEventIssueRequest>();
        var warnings = new List<ProducerValidationEventIssueRequest>();
        var rows = new List<ProducerRow>
        {
            BuildProducerRow(packagingType: PackagingType.Household, materialType: MaterialType.Plastic, recyclabilityRating: string.Empty, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025"),
            BuildProducerRow(packagingType: PackagingType.NonHousehold, materialType: MaterialType.Plastic, recyclabilityRating: RecyclabilityRating.Green, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025"),
            BuildProducerRow(producerSize: ProducerSize.Small, packagingType: PackagingType.Household, materialType: MaterialType.Plastic, recyclabilityRating: RecyclabilityRating.Amber, dataSubmissionPeriod: DataSubmissionPeriodTestData.Year2025H1, submissionPeriod: "January to June 2025")
        };
