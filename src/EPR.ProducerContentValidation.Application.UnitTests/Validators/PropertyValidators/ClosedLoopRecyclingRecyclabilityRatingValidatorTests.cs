...
[TestClass]
public class ClosedLoopRecyclingRecyclabilityRatingValidatorTests : ClosedLoopRecyclingRecyclabilityRatingValidator
{
    private readonly ClosedLoopRecyclingRecyclabilityRatingValidator _systemUnderTest;

    public ClosedLoopRecyclingRecyclabilityRatingValidatorTests()
    {
        _systemUnderTest = new ClosedLoopRecyclingRecyclabilityRatingValidator();
    }
    ...
    [DataRow("G-M")]
    [TestMethod]
    public void ClosedLoopRecyclingRecyclabilityRatingValidator_ContainsError918_WhenRecyclabilityRatingIsNotEmpty(string recyclabilityRating)
    {
        // Arrange
        var producerRow = BuildProducerRow(PackagingType.ClosedLoopRecycling, recyclabilityRating);
        ...
        // Assert
        result
            .ShouldHaveValidationErrorFor(x => x.RecyclabilityRating)
            .WithErrorCode(ErrorCode.ClosedLoopRecyclingRecyclabilityRatingInvalidErrorCode);
    }

    [TestMethod]
    public void ClosedLoopRecyclingRecyclabilityRatingValidator_DoesNotContainError_WhenRecyclabilityRatingIsNull()
    {
        // Arrange
        var producerRow = BuildProducerRow(PackagingType.ClosedLoopRecycling, null);
    ...
    private static ProducerRow BuildProducerRow(string packagingType, string? recyclabilityRating)
    {
        return new ProducerRow(null, null, "123456", 0, null, ProducerSize.Large, packagingType, null, null, null, null, null, "1", "1", null, null, recyclabilityRating);
    }
}
