...
[TestClass]
public class HouseholdDrinksContainerPackagingClassValidatorTests : HouseholdDrinksContainerPackagingClassValidator
{
    private readonly HouseholdDrinksContainerPackagingClassValidator _systemUnderTest;

    public HouseholdDrinksContainerPackagingClassValidatorTests()
    {
        _systemUnderTest = new HouseholdDrinksContainerPackagingClassValidator();
    }
    ...
    {
        // Arrange
        var producerRow = BuildProducerRow(PackagingType.HouseholdDrinksContainers, packagingClass);
    ...
    [TestMethod]
    public void PreValidate_ReturnsFalse_WhenPackagingTypeIsNotDrinksContainers()
    {
        // Arrange
