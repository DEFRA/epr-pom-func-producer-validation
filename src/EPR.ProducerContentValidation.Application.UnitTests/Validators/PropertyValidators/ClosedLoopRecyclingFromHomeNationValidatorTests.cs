...
[TestClass]
public class ClosedLoopRecyclingFromHomeNationValidatorTests : ClosedLoopRecyclingFromHomeNationValidator
{
    private readonly ClosedLoopRecyclingFromHomeNationValidator _systemUnderTest;

    public ClosedLoopRecyclingFromHomeNationValidatorTests()
    {
        _systemUnderTest = new ClosedLoopRecyclingFromHomeNationValidator();
    }
    ...
    [TestMethod]
    public void ClosedLoopRecyclingFromHomeNationValidator_ContainsError916_WhenFromHomeNationIsNotEmpty(string fromHomeNation)
    {
        // Arrange
        var producerRow = BuildProducerRow(PackagingType.ClosedLoopRecycling, fromHomeNation);
    ...
    [TestMethod]
    public void ClosedLoopRecyclingFromHomeNationValidator_DoesNotContainError_WhenFromHomeNationIsNull()
    {
        // Arrange
        var producerRow = BuildProducerRow(PackagingType.ClosedLoopRecycling, null);
