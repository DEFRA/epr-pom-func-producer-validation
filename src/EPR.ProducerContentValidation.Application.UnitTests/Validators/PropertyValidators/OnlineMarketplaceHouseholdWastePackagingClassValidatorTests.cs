...
[TestClass]
public class OnlineMarketplaceHouseholdWastePackagingClassValidatorTests : OnlineMarketplaceHouseholdWastePackagingClassValidator
{
    private readonly OnlineMarketplaceHouseholdWastePackagingClassValidator _systemUnderTest;

    public OnlineMarketplaceHouseholdWastePackagingClassValidatorTests()
    {
        _systemUnderTest = new OnlineMarketplaceHouseholdWastePackagingClassValidator();
    }
    ...
    {
        // Arrange
        var producerRow = BuildProducerRow(ProducerType.SoldThroughOnlineMarketplaceYouOwn, PackagingType.Household, packagingClass);
    ...
    {
        // Arrange
        var producerRow = BuildProducerRow(ProducerType.SoldAsEmptyPackaging, PackagingType.Household, PackagingClass.TotalPackaging);
        var validationContext = new ValidationContext<ProducerRow>(producerRow);
        var validationResult = new ValidationResult();
