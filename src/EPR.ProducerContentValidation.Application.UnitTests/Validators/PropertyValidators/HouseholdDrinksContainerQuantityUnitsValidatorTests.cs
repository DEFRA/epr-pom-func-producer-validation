...
[TestClass]
public class HouseholdDrinksContainerQuantityUnitsValidatorTests : HouseholdDrinksContainerQuantityUnitsValidator
{
    private readonly HouseholdDrinksContainerQuantityUnitsValidator _systemUnderTest = new HouseholdDrinksContainerQuantityUnitsValidator();
    ...
    public void PreValidate_ReturnsFalse_WhenPackagingTypeIsNotDrinksContainer(string packagingType)
    {
        // Arrange
